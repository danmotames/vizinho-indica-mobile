...
const styles = StyleSheet.create({ base: { minHeight: 40, paddingHorizontal: spacing.md, justifyContent: "center", borderRadius: radius.pill, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border }, selected: { backgroundColor: colors.primary, borderColor: colors.primary }, text: { color: colors.muted, fontFamily: fonts.semibold, fontSize: 13 }, selectedText: { color: colors.surface }, pressed: { opacity: 0.82, transform: [{ scale: 0.98 }] } });
